...
class LoginPage extends Page {
    ...
    */
    ...
    get loginButton()     { return browser.element('button.sign-in'); }
     ...
     */
    open () {
        super.open('http://demo.christrees.com/react-app/')       //this will append `login` to the baseUrl to form complete URL
        browser.pause(1000);
    }
    /**
    ...
    waitForloginPageToLoad () {
      if(!this.loginButton.isVisible()){
        this.loginButton.waitForVisible(5000);
      }
    }
